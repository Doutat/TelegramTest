<template>
    ...
    <f7-navbar back-link="Back"> 
         <f7-nav-left>
    <f7-link> <img  src="../img/img_avatar2.png" width="30" alt=""></f7-link>
  </f7-nav-left>
       <f7-nav-title>Elisabeth</f7-nav-title>
  <f7-nav-right>
...
<f7-popover class="popover-menu">
      <f7-list>
        ...
        <f7-list-item link="/appel/"  popover-close title="Appeler"></f7-list-item>
        <f7-list-item link="#" popover-close title="Rechercher" class="searchbar-enable" data-searchbar=".searchbar-demo1"></f7-list-item>
        <f7-list-item link="#" popover-close title="Form Inputs"></f7-list-item>
         <f7-list-item link="#" popover-close class="popover-open"  data-popover=".popover-about" title="About"></f7-list-item>
      </f7-list>
    </f7-popover>

<f7-popover class="popover-about">
             <f7-block class="popover-inner block center">
